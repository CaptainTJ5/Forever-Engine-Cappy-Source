...
class Character extends FNFSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'cappy':
				tex = Paths.getSparrowAtlas('characters/Cappy');
				frames = tex;
				animation.addByPrefix('idle', 'Cappy Idle', 24, false);
				animation.addByPrefix('singUP', 'Cappy singUP', 24);
				animation.addByPrefix('singRIGHT', 'Cappy singRIGHT', 24);
				animation.addByPrefix('singDOWN', 'Cappy singDOWN', 24);
				animation.addByPrefix('singLEFT', 'Cappy singLEFT', 24);

			case 'cappy2':
				tex = Paths.getSparrowAtlas('characters/Cappy2');
				frames = tex;
				animation.addByPrefix('idle', 'Cappy Idle', 24, false);
				animation.addByPrefix('singUP', 'Cappy singUP', 24);
				animation.addByPrefix('singRIGHT', 'Cappy singRIGHT', 24);
			...
			case 'cappy3':
				tex = Paths.getSparrowAtlas('characters/Cappy3');
				frames = tex;
				animation.addByPrefix('idle', 'Cappy Idle', 24, false);
				animation.addByPrefix('singUP', 'Cappy singUP', 24);
				animation.addByPrefix('singRIGHT', 'Cappy singRIGHT', 24);
			...
			case 'bfcappy':
				frames = Paths.getSparrowAtlas('characters/bfcappy');
